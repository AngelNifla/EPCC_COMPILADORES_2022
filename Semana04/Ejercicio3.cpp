/*
Proponga un diagrama de transición y su correspondiente programa para el
reconocimiento de números (Ejemplo: 45,-45, 0.15,-0.15,.67,-.67).
*/
...
int main()
{
    int Matriz[6][5]={{2,3,1,1,0},{0,0,0,0,0},{1,3,1,1,0},
    {1,3,1,4,10},{1,5,1,1,0},{1,5,1,1,10}};    //Tabla de Transicion.
    //la columna + 0 - es la posicion 0 del array.
    //la columna digito es la posicion 1 del array.
    //la columna letra es la posicion 2 del array.
    //la columna punto es la posicion 3 del array.
    //la columna FDC es la posicion 4 del array.
